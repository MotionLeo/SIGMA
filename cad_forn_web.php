...
<html>
    ...
    <body>
        ...
        <main>
            <form name="Cadastro_Fornecedor" action="cad_forn.php" method="POST">
                <label for="cnpj_forn">CNPJ</label>
                <input type="number" id="cnpj_forn" class="input_padrao" required name="cnpj_forn">  

                <label for="raz_forn">Razão Social</label>
                <input type="text" id="raz_forn" class="input_padrao" required name="raz_forn">
                
                <legend>IE</legend>
                    <select class="ie_forn" required name="ie_forn">
                        <?php
                            for($i = 1; $i <= 50; $i++){ 
                ...
                <input type="email" id="email_forn" class="input_padrao" placeholder="seuemail@dominio.com" name="email_forn">

                <label for="tel_forn">Telefone</label>
                <input type="tel" id="tel_forn" class="input_padrao" placeholder="(XX) XXXX-XXXX" name="tel_forn">
                
                <fieldset>
                    <legend>Estado</legend>
                    <select class="estado" required name="estado">
                    <option>SP</option>
                        <option>AC</option>
                        <option>AL</option>
                        <option>AP</option>
                    ...
                    <input type="text" id="cep_forn" class="input_padrao" required name="cep_forn">
                    
                    <input type="button" id="btn_cep" name="btn_cep" value="Consultar CEP">
                    

                    <label for="cidade_forn">Cidade</label>
                    <input type="text" id="cidade_forn" class="input_padrao" required name="cidade_forn">

                    <label for="bairro_forn">Bairro</label>
                    <input type="text" id="bairro_forn" class="input_padrao" required name="bairro_forn">

                    <label for="rua_forn">Rua</label>
                    <input type="text" id="rua_forn" class="input_padrao" required name="rua_forn">

                    <label for="num_forn">Número</label>
                    <input type="number" id="num_forn" class="input_padrao" required name="num_forn">
                </fieldset>
